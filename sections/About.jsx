...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        <span className="font-extrabold text-white text-xl">Metaverse</span> is
        ...
        <span className="font-extrabold text-white text-xl">Madness</span> of
        the <span className="font-extrabold text-white text-xl">MetavłaśVcs</span> of today, using only{' '}
        <span className="font-extrabold text-white text-9xl">VR</span> devices
        you can easily explore the metaverse world you want, turn your dreams
        into reality. Let's{' '}
        <span className="font-extrabold text-white text-xl">explore</span> the
